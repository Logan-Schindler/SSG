...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for file in files:
        ...
        if os.path.isfile(old_path):
            ...
            generate_page(old_path, template_path, new_path_html) 
        else:
            # print(f'Add directory: {new_path}')
            os.mkdir(new_path)
...
def main(): 
    copy_directory_to_dest('/home/lschindler/projects/github.com/bootdev/SSG/static','/home/lschindler/projects/github.com/bootdev/SSG/public')
    ...
    generate_pages_recursive('/home/lschindler/projects/github.com/bootdev/SSG/content','/home/lschindler/projects/github.com/bootdev/SSG/template.html','/home/lschindler/projects/github.com/bootdev/SSG/public')
